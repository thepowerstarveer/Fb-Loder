...
def show_termux_message():
    ...
    termux_message = r"""
╔═══════════════════════════════════════════════════════════════════════════╗
║  {0}WONER      : TH3 P0W3R ST9R V33R                                              ║
║  {1}RULL3X     : VEER THE LEGEND                                          ║
║  {1}FACEBOK    : ༺፨ ͟͟͞͞ ᪣᪥ ⃝༄⃟𝐇ə͜͡ə ɪ͜͡s ༄⃟𝐓Ħ͜͡ə βə͜͡əɡɪs͜͡ʈ ⟨๏𑁍᭄๏⟩» ⃝ ⃝༄⃟𝐂ɽɪ͜͡ɪɱɪ͜͡ɪηɑɭ༄̽•››̈̈️ 𝐅ʈ៚ 𝐕𝐞͜͡𝐞ɼ ⃝༄⃟͙̈࿐                                            ║
║  {2}RULS       : MULTI TOKEN CONVO                                           ║
║  {3}GITHUB     : TH3-HERE                                                   ║ 
║  {1}WH9TS9P    : +918354928340                                              ║
╚═══════════════════════════════════════════════════════════════════════════╝
    ...
    while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                print(Fore.GREEN + f"└────────────────────────────────────────────────────────────────────┘\n")
                print(Fore.YELLOW + "\033[1;37m<<======== MADE BY VEER😈🩷 ======>>")
                print("\n" + ("─" * 80) + "\n")
            except requests.exceptions.RequestException:
